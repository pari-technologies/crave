...
import 'package:a_crave/forgotPasswordSend.dart';
...
class ForgotPasswordState extends State<ForgotPassword> {
  ...
  void goToForgotPassSend() {
    // setState(() {
    //   Navigator.of(context).pushReplacementNamed("/forgotPasswordSend");
    // });
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => ForgotPasswordSend()));
  }
